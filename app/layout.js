...
export const metadata = {
  title: `梁清波 · 个人履历与专业作品集 | ${profile.hero.headline}`,
  description:
    '梁清波 (Boone Liang) 个人履历与专业作品集：华中科技大学统计学理学学士，全资子公司从 0 到 1 创办奠基，大宗商业工程总负责（135 份合同 6.83 亿），上市公司合规与信息披露 A 级；善用数据、报表与 AI 工具为生意提效降本，熟悉各类数据处理与统计工具。',
};
