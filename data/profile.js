  ...
  pillars: [
    {
      ...
      period: '2024 - 至今',
      title: '业务分析与AI全栈研发',
      fact: '以 VIBE+ 敏捷研发方法论（LLM×Harness 支点）自主推进 AI Agent 状态机、企业混合 RAG 与 DuckDB 列式中枢研发。',
    ...
    },
    {
      ...
      period: '2014 - 2024',
      title: '重大工程大盘与商务博弈',
      fact: '统领大宗商业工程合同大盘，主导遵义大酒店等破亿地标交付与四维回款体系。',
      mono: '大宗合同大盘 · 破亿级地标交付 · 多轨博弈定价 · 稳健经营毛利',
    ...
    },
    {
      ...
      period: '2014 - 2024',
      title: '企业创办与制度治理',
      fact: '从 0 到 1 组建初创团队编制，主笔八大模块管理制度总纲与旗舰展厅，奠定多年合规与零仲裁底盘。',
      mono: '超募资金创办 · 初创团队编制 · 制度总纲 · 多年零仲裁',
  ...
  rows: [
    {
      ...
      bullets: [
        '结合多年数理分析与实体业务经验，以 VIBE+ 敏捷研发方法论（LLM×Harness 支点）自主推进企业级数字化原型研发，主导混合检索 RAG 知识库、工作流编排 Agent 状态机与外贸业务自动化工具的系统设计与开发。',
    ...
    },
    {
      ...
      bullets: [
        '【企业创办与制度奠基】承接集团上市公司超募资金创办全资子公司，从 0 到 1 组建初创团队编制，主笔发布八大业务模块管理制度总纲与现代化旗舰展厅，奠定多年用工合规与零劳动仲裁治理底盘。',
        '【重大工程专班总操盘】统领大宗盖章合同大盘，打破传统科层以重大工程为战元牵头跨部门敏捷专班，主揽并总操盘遵义大酒店等破亿国宾级标杆工程全流程高品质交付。',
        '【多轨定价博弈与毛利保障】首创穿透源头工坊出厂成本底盘，建立"出厂成本 ➔ 内部控制 ➔ 商务底限 ➔ 正式报审报价"多级商务防波堤与动态加乘模型，在大货批量采购中运用价值工程 (VE) 刚性降本，始终坚守稳健的综合经营毛利率底线。',
        '【资金回款保障与审计确权】构建多维度资金回款机制，破解背靠背免责霸王条款，实现全盘高回款率；挂帅竣工结算答辩，凭实测底账与闭环现场签证抗辩财评审计，阻断审减风险，守住合法经营成果。',
      ],
      tags: ['全资子公司创办', '制度总纲', '大宗合同大盘', '破亿级标杆专班', '稳健毛利', '回款保障'],
    },
    {
      ...
      bullets: [
        '前段在总经办搭建经营数据分析模型，督办多期月度经营例会决议按期落实，保障闭环办结。',
        '后调任证券事务部专职，主导中小企业私募债全流程尽职调查与专业底稿归档；撰写同业竞品财务对标报告；负责深交所法定信披公告，保持零监管函件与最高 A 级考评。',
      ],
    ...
    },
    {
      ...
      bullets: [
        '系统修读数学分析、高等代数与几何、常微分方程、概率论、数理统计、多元统计分析等数理核心骨干课，修满 160+ 学分。',
  ...
  items: [
    {
      ...
      scope: '生产级自研系统矩阵 · DuckDB 插件生态 · FastMCP 智能体协议 · RAG/Agent 工具链',
      abstract: '以 VIBE+ 敏捷研发方法论（LLM×Harness 支点）展现围绕 DuckDB 现代列式湖仓与丰富插件生态（vss 向量检索、httpfs 远程直查、跨源 scanner、spatial 空间计算）、Model Context Protocol (FastMCP) 统一智能体数据协议、混合检索 RAG 与流程编排状态机，实现从本地分析到智能体即席推理的全栈研发闭环。',
      cta: '查看研发全貌',
      monograph: 'monograph-ai',
    },,
...

    {
      ...
      scope: '全资子公司创办 · 制度总纲 · 大宗合同大盘 · 破亿级地标交付',
      abstract: '完整复盘全资子公司创办历程、制度建设与商业工程大盘操盘实践，沉淀多轨博弈定价模型、价值工程降本与回款保障体系。',
      cta: '查看大盘全景',
      monograph: 'monograph-cloud',
    },,
  ...
  tiles: [
    {
      ...
      items: [
        ...
        'DuckDB 列式湖仓 · FineBI 报表 · SPSS / SAS 高难度统计建模',
        'FastMCP 协议架构 · DuckDB MCP 即席分析中枢 · 安全只读沙箱',
        '混合检索 RAG 知识库（Dense + Sparse + 重排序）',
        'Agent 状态机 · 工作流编排 · 自动化工具链',
        'Python / FastAPI / TypeScript · Git / Linux 敏捷交付',
      ],
    },
    {
      title: '数理统计与数据分析',
    ...
    },
    {
      title: '企业商业操盘与组织治理',
      items: [
        '全资子公司从 0 到 1 组织架构搭建与初创编制制定',
        '重大商业工程跨部门敏捷专班组建与端到端实操操盘',
        '采销多轨博弈定价模型与价值工程（VE）降本',
        '大宗工程全生命周期集中交验与合法收益确权',
      ],
    },
    {
      title: '上市公司治理与资本合规',
      items: [
        '深交所上市公司法定信息披露（考评最高 A 级）',
        '中小企业私募债及重大融资尽调底稿管理',
        '总经办经营例会决议闭环督办与跨部门推进',
      ],
    },
